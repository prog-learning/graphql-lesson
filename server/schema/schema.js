...
const books = [
  ...
  { name: 'The Hero of Ages', genre: 'Fantasy', id: '4', authorId: '2a' },
  { name: 'The Long Earth', genre: 'Sci-Fi', id: '3', authorId: '3a' },
  { name: 'The Colour of Magic', genre: 'Fantasy', id: '5', authorId: '3a' },
  { name: 'The Light Fantastic', genre: 'Fantasy', id: '6', authorId: '3a' },
]
const authors = [
